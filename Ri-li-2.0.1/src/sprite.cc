...
{
  static int NumAf=-1; // Num�ro su sprite affich�
  int i,Old;
  int Hor;

  if(AfficheC==true) {
    Hor=SDL_GetTicks();
    i=(Hor/(1000/25))%Sprites[chargeur].N; // Calcule le num�ro su sprite � afficher
...
bool LoadLangue()
{
  ...
  delete [] Buf; // Lib�re la m�moire du fichier des sprites
